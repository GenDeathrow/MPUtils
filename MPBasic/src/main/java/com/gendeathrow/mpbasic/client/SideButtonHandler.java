...
public class SideButtonHandler implements GuiYesNoCallback
{
	...
	{
		TabRegistry.registerTab(changelogButton = new SideTabButton(400, MPBSettings.changeLogTitle).setIcon(0, 0));
		TabRegistry.registerTab(bugReportButton = new SideTabButton(401, "Report Bug").setIcon(3, 0));
		TabRegistry.registerTab(supportButton = new SideTabButton(402, "Support").setIcon(2, 0));
	...
	public void confirmClicked(boolean result, int id) 
	{
		if(!result) 
		{
			...
			try
			{
				...
				String url = "";
				if(id == 0) url = MPBSettings.bugURL;
