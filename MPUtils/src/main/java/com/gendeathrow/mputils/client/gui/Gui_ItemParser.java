...
public class Gui_ItemParser extends GuiScreen
{
    ...
    public Gui_ItemParser(int commandList, CommandElement commandIn, int index)
    {
	...
	public void initGui()
    {
        ...
        this.commandTextField = new GuiTextField(2, this.fontRenderer, this.width / 2 - 150, 90, 300, 20);
        this.commandTextField.setMaxStringLength(32500);
        this.commandTextField.setFocused(true);
        this.commandTextField.setText(command.getCommand());
        
        this.titleTextField = new GuiTextField(2, this.fontRenderer, this.width / 2 - 150, 50, 300, 20);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRenderer, I18n.format("mp.quickCommands.edit.title", new Object[0]), this.width / 2, 25, 16777215);
        this.drawString(this.fontRenderer, I18n.format("mp.text.title", new Object[0]), this.width / 2 - 150, 37, 10526880);
        this.drawString(this.fontRenderer, I18n.format("advMode.command", new Object[0]), this.width / 2 - 150, 77, 10526880);
        this.commandTextField.drawTextBox();
        this.titleTextField.drawTextBox();
        
        int i = 120;
        int j = 0;
        this.drawString(this.fontRenderer, I18n.format("advMode.nearestPlayer", new Object[0]), this.width / 2 - 150, i + j++ * this.fontRenderer.FONT_HEIGHT, 10526880);
        this.drawString(this.fontRenderer, I18n.format("advMode.randomPlayer", new Object[0]), this.width / 2 - 150, i + j++ * this.fontRenderer.FONT_HEIGHT, 10526880);
        this.drawString(this.fontRenderer, I18n.format("advMode.allPlayers", new Object[0]), this.width / 2 - 150, i + j++ * this.fontRenderer.FONT_HEIGHT, 10526880);
        this.drawString(this.fontRenderer, I18n.format("advMode.toggleBoolean", new Object[0]), this.width / 2 - 150, i + j++ * this.fontRenderer.FONT_HEIGHT, 10526880);
        this.drawString(this.fontRenderer, I18n.format("advMode.allEntities", new Object[0]), this.width / 2 - 150, i + j++ * this.fontRenderer.FONT_HEIGHT, 10526880);
