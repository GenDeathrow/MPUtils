...
public class RenderAssist {
	...
	public static void drawScalableTextruedBoxBordered(int x, int y, int u, int v, int width, int height)
	{
		int borderWidth = 4;
		
		GL11.glTexParameteri(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_WRAP_S, GL11.GL_REPEAT);
		// top
		drawTexturedModalRectCustomSize(x + 4, y, u + 4, v, 152, 3, width - 8, 3);
		// left
		drawTexturedModalRectCustomSize(x, y + 3, u, v + 4, 4, 3,  4, height - 6);
	    //right
		drawTexturedModalRectCustomSize(x + width - 4, y + 3, u + 156, v + 4, 4, 3, 4, height - 6);
	    //bottom
		drawTexturedModalRectCustomSize(x + 4, y + height - 3, u + 4, v + 29, 152, 3, width - 8, 3);
	    
		
		
		//topleftCorner
		drawTexturedModalRect(x, y, u, v, 4, 3);
		
		//toprightCorner
		drawTexturedModalRect(x + width - 4, y, u + 156, v, 4, 3);
		
		//bottomleftCorner
		drawTexturedModalRect(x, y + height - 3, u, v + 29, 4, 3);
		
		//bottomrightCorner
		drawTexturedModalRect(x + width - 4, y + height - 3, u + 156, v + 29, 4, 3);
	}
 ...
 */
    ...
    public static void renderItemScaled(ItemStack stack, int x, int y, float scale, RenderItem render, Minecraft mc)
    {
        RenderHelper.enableGUIStandardItemLighting();
     ...
     *   renderutils.guiscissor
     *   gltranslane (posx+(scrollx)*zs, posY+(scrollY)*zs, 0)
